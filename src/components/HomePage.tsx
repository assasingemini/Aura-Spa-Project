...
import {
    ArrowRight, Star, CheckCircle, ChevronLeft, ChevronRight,
    Sparkles, Wind, Droplets, Zap, Heart, Clock, Award
} from "lucide-react";
import { services, specialists, testimonials, blogPosts, pricingPackages, IMAGES } from "../app/data/mockData";
...
function SpaGallerySection() {
    const spaImages = [
        { image: "https://images.unsplash.com/photo-1700142360825-d21edc53c8db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Tranquil Treatment Rooms" },
        { image: "https://images.unsplash.com/photo-1640791416299-25645e72d186?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Aromatherapy Blends" },
        { image: "https://images.unsplash.com/photo-1680163660834-fa4f67748e21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Hot Stone Therapy" },
        { image: "https://images.unsplash.com/photo-1761718210089-ba3bb5ccb54f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Rejuvenating Facials" },
        { image: "https://images.unsplash.com/photo-1669281392832-9181a2b484af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Organic Body Scrubs" },
        { image: "https://images.unsplash.com/photo-1595788088802-0e32ff9306f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080", title: "Floral Hydrotherapy" }
    ];
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {spaImages.map((item, i) => (
                        <div key={i} className="group relative rounded-2xl overflow-hidden border border-[#FFC5C1]/50 hover:border-[#FF9689]/60 hover:shadow-xl hover:shadow-[#FEAEA7]/30 transition-all duration-500">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    {testimonials.slice(0, 3).map((t) => (
                        <div key={t.id} className="p-8 rounded-2xl bg-white border border-[#FFC5C1]/50 hover:border-[#FF9689]/60 hover:shadow-lg hover:shadow-[#FEAEA7]/40 transition-all duration-300">
                    ...
                    {specialists.map((spec) => (
                        <div key={spec.id} className="group text-center">
                            <div className="relative mb-6 mx-auto w-48 h-48 rounded-full overflow-hidden border-2 border-[#FFC5C1]/50 group-hover:border-[#FF9689]/60 group-hover:shadow-xl group-hover:shadow-[#FEAEA7]/40 transition-all duration-500">
                                <ImageWithFallback src={spec.image} alt={spec.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {pricingPackages.map((pkg) => (
                        <div
                            key={pkg.id}
                            className={`relative p-8 rounded-2xl transition-all duration-300 ${pkg.featured
                        ...
                        >
                            ...
                            <Link
                                href="/booking"
                                className={`w-full flex items-center justify-center gap-2 py-4 rounded-full text-sm font-medium transition-all duration-300 group ${pkg.featured
        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
                    ...
                    <Link href="/blog" className="flex items-center gap-2 text-[#FF9689] hover:text-[#FFC6A4] transition-colors group">
